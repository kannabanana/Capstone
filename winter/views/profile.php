<?php 
	...
	//include header or sidebar for navigation and database access
          include("_header.php"); 
...
<!--this is for css and javascript-->
...
$id = $_SESSION['uid'];		//check if session id exists, redirect otherwise
...
if($result = $db->query("select * from employee_information where user_id = '$id'")){
		while($obj = $result->fetch_object()){					//query for employee information based on a given id and display first name, last name, user name, phone number etc.
...
<div class="container">
      ...
      <div class="col-md-5  toppad  pull-right col-md-offset-3 ">
        ...
        <A href="submit_logout.php" >Logout</A>		<!--give them the option to logout-->
       <br>
      </div>
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <div class="row">     
				<!--displaying the information gathered above-->
			  ...
			  <?php }?>                <div class=" col-md-8 col-lg-8 " align="right"> 
                  <table class="table table-user-information" >
                    <tbody>
                      <tr>
                        <td>Email:</td>
                        <td><a href="mailto:<?php echo $email; ?> "><?php echo $email;  ?></a> </td>			<!--displaying email, phone, major, hiredat, end date etc-->
                      </tr>
                      <tr>
                        <td>Phone:</td>
            ...
            <div class="panel-body">
              <div class="row">     
                <div class=" col-md-12 col-lg-12 "> 
				 ...
				 <tbody>
				<?php $previous_id = -1; 
					if($result = $db->query("select * from log_task WHERE user_id = '$id' ORDER BY task_id desc ")){
						while($obj = $result->fetch_object()){ 
							$task_id = htmlspecialchars($obj->task_id);
							if($task_id === $previous_id){
								$logged_hours = $logged_hours + htmlspecialchars($obj->hours);
								continue; 
							}
							elseif($previous_id === -1){
							...
							$previous_id = $task_id; 
							$assigned_hours = 0;
							if($result2 = $db->query("select * from assignments where task_id = '$task_id'")){
								while($obj2 = $result2->fetch_object()){ 
									$assigned_hours = $assigned_hours + $obj2->hours;
								}
								if($result3 = $db->query("select * from task where task_id = '$task_id'")){
									while($obj3 = $result3->fetch_object()){ 
										$task_name = $obj3->name;
										$task_type_id = $obj3->task_type_id;
