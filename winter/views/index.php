     ...
     <!-- --------------------------------- Navigation Bar --------------------------------- -->
          <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
              <div class="container">
                  <div class="navbar-header">
                      <a class="navbar-brand" href="http://web.engr.oregonstate.edu/~kannas/database-pr/Database-Project/views/profile.php">EEC</a>
                  </div>
                  <!-- --------------------------------- Login Form --------------------------------- -->
                  <form data-toggle="validator" role="form" class="navbar-form pull-right" action="http://web.engr.oregonstate.edu/~kannas/database-pr/Database-Project/views/submit_login.php" autocomplete="off" method="post">
      ...
      <div class="container">
          <div class="row">
              <div class="col-md-6">
                  <h1><br><br></h1>
                  <h2>This is where you will see news updates of the week!</h2>
              </div>
      <!-- --------------------------------- Registration Form --------------------------------- -->
              <div class="col-md-6">
